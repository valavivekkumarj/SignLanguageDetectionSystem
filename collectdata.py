...
# Directory where captured images will be saved    Image    JioCloud-Download\ImageImage\D C:\JioCloud-Download\Image\D   Image\D
directory = "Image/"
...
while True:
    ...
    row = frame.shape[1]  # height
    col = frame.shape[0]  # width
