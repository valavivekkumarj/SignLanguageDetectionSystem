...
########################not required for simple output without design    =======>start
...
#         y1 = (
#             60 + num * 40
#         )  # Starting y-coordinate for the rectangle (spacing between rectangles)
#         x2 = int(
#             prob * 100
#         )  # Ending x-coordinate based on probability (scaled to 100% width)
#         y2 = (
#             90 + num * 40
#         )  # Ending y-coordinate for the rectangle (spacing + rectangle height)
...
#         text_y = (
#             85 + num * 40
#         )  # y-coordinate for the text label (spacing + text baseline)
...
#     return output_frame
# ================================================================= =======>end    prob_visulizing fun end here
...
with mp_hands.Hands(
    ...
    while cap.isOpened():
        ...
        frame = cv2.rectangle(frame, (0, 40), (300, 400), (0, 0, 255), 2)
        ...
        sequence = sequence[
            -30:
        ]  # Keep only the last 30 frames for sequence input video mathi cheli 30 frame use kari video ma continue 10 miliseconds pasi frame ave
